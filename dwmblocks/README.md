...
fork from [dwmblocks-async](https://github.com/UtkarshVerma/dwmblocks-async.git)
...
My volume block _never_ updates on its own, instead I have this command run along side my volume shortcuts in `dwm` to only update it when relevant.
...
`xgetrootname` stolen from [dsblocks](https://github.com/ashish-yadav11/dsblocks)
...
- [dsblocks](https://github.com/ashish-yadav11/dsblocks)
- [dwmblocks-async](https://github.com/UtkarshVerma/dwmblocks-async.git)
